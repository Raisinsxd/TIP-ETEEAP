...
import DataPrivacyConsent from './undertaking'; // Your consent component
...
export default function ApplicationForm() {
  ...
  // --- 👇 2. ADD CONSENT STATE AND ROUTER ---
  ...
  const handleConsentDisagree = () => {
    ...
    router.push('/dashboard'); // <-- You can change this path
  };
  // ---
  ...
  if (!hasConsented) {
    return (
      // This wrapper centers the modal, just like your form
  ...
  // If consented, then show the success screen or the form
  if (submitSuccess) {
    return (
  ...
  // If consented and not submitted, show the form
  return (
